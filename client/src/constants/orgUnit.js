...
export const ORG_UNIT_TYPE_LABELS = {
    ...
    [ORG_UNIT_TYPE.DACKHU]: 'Công an đặc khu',
...
export const CHILD_TYPES_BY_PARENT = {
    [ORG_UNIT_TYPE.TINH]: [ORG_UNIT_TYPE.PHONG, ORG_UNIT_TYPE.XA, ORG_UNIT_TYPE.PHUONG, ORG_UNIT_TYPE.THI_TRAN, ORG_UNIT_TYPE.DACKHU, ORG_UNIT_TYPE.DON, ORG_UNIT_TYPE.TRAM],
    ...
    [ORG_UNIT_TYPE.DACKHU]: [ORG_UNIT_TYPE.DOI, ORG_UNIT_TYPE.TO],
